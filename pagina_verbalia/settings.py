"""
Django settings for pagina_verbalia project.
...
SECRET_KEY = 'django-insecure-sw996xeqe$i^e$t-k^%e0l7*(&e3w^56-3%&&lw!cw9%c_#!)d'
...
ROOT_URLCONF = 'pagina_verbalia.urls'
...
WSGI_APPLICATION = 'pagina_verbalia.wsgi.application'
